                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="parent" class="form-control" style="width: 100%" data-placeholder="">
                                ...
                                {{$model->optionCategory(0,1,4,$data->parent,$data->id,'post')}}
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="display" class="form-control" style="width: 100%" data-placeholder="Trạng thái">
                                ...
                                <option value="1" {{ ($data->display==1) ? 'selected' : ''}}>Trang bệnh lý</option>
                                <option value="2" {{ ($data->display==3) ? 'selected' : ''}}>chân trang</option>
                            </select>
                        </div>
                        <div class="form-group">
