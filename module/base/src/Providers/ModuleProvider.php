...
class ModuleProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->register(\Diseases\Providers\ModuleProvider::class);
        $this->app->register(\Hospital\Providers\ModuleProvider::class);
        $this->app->register(\Video\Providers\ModuleProvider::class);
        $this->app->register(\Comment\Providers\ModuleProvider::class);
        $this->app->register(\Document\Providers\ModuleProvider::class);
        $this->app->register(\Doctor\Providers\ModuleProvider::class);
        $this->app->register(\Donate\Providers\ModuleProvider::class);
