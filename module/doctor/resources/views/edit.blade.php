            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Sửa Bác sỹ</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để sửa Bác sỹ</p>
                    </div>
                    <div class="panel-body">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                           ...
                                           type="text"
                                           value="{{$data->name}}"
                                           placeholder="VD : Nguyễn Thành An">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor2" name="content" class="form-control" rows="3" placeholder="Thông tin chi tiết">{{$data->content}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="" name="meta_desc" class="form-control" rows="3" placeholder="Thẻ Meta description">{!! sub($data->meta_desc,190) !!}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="category" class="form-control" style="width: 100%" data-placeholder="">
                                ...
                                @foreach($khoaList as $k)
                                    <option value="{{$k->id}}" {{($data->category==$k->id) ? 'selected' : ''}}>{{$k->name}}</option>
                                @endforeach
                            </select>
                        </div>
