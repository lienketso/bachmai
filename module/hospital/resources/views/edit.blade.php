...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::hospital.index.get')}}">Danh mục viện & khoa</a></li>
        <li class="active">Sửa Danh mục viện & khoa</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Sửa Danh mục viện & khoa</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để Sửa Danh mục viện & khoa </p>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="parent" class="form-control" style="width: 100%" data-placeholder="">
                                ...
                                {{$model->optionCategory(0,1,4,$data->parent,$data->id,'hospital')}}
                            </select>
                        </div>
                        <div class="form-group">
