...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Thêm Danh mục viện & khoa</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm Danh mục viện & khoa</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm Danh mục viện & khoa mới</p>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="parent" class="form-control" style="width: 100%" data-placeholder="">
                                ...
                                {{$model->optionCategory(0,1,4,0,0,'hospital')}}
                            </select>
                        </div>
                        <div class="form-group">
