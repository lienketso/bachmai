...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::hpost.index.get')}}">viện & khoa</a></li>
        <li class="active">Thêm viện & khoa</li>
    </ol>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm viện & khoa</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm viện & khoa mới</p>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input class="form-control"
                                   ...
                                   type="text"
                                   value="{{old('name')}}"
                                   placeholder="Tên viện hoặc khoa">
                        </div>
                        <div class="form-group">
                            <label>Mô tả</label>
            ...
            <div class="col-sm-4">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <select id="" name="category" class="form-control" style="width: 100%" data-placeholder="Danh mục chủ đề">
                                <option value="0">--Chọn danh mục--</option>
                                {{$catmodel->optionCategory(0,1,4,0,0,'hospital')}}
                            </select>
                        </div>
                        <div class="form-group">
