...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Sửa viện & khoa</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Sửa viện & khoa</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để sửa viện & khoa</p>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <select id="" name="category" class="form-control" style="width: 100%" data-placeholder="Danh mục bài viết">
                                ...
                                {{$catmodel->optionCategory(0,1,4,$data->category,0,'hospital')}}
                            </select>
                        </div>
                        <div class="form-group">
