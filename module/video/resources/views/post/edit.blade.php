...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::hpost.index.get')}}">Video</a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="" name="description" class="form-control" rows="3"
                                      placeholder="Copy link trên youtube, ví dụ : https://www.youtube.com/watch?v=gxPrLQKi46Q&t=898s">{{$data->description}}</textarea>
                        </div>
                        <div class="form-group">
