...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::adver.index.get')}}">Logo quảng cáo</a></li>
        <li class="active">Sửa logo quảng cáo</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Sửa logo quảng cáo</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để logo quảng cáo </p>
                    </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="custom-file">
                                ...
                                <div class="thumbnail_w" style="padding-top: 10px">
                                    <img src="{{($data->path_name!='') ? upload_url($data->path_name) : public_url('admin/themes/images/no-image.png')}}" width="100">
                                </div>
                            </div>
                        </div>
